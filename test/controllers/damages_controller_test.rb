...
class DamagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create damage" do
    assert_difference('Damage.count') do
      post damages_url, params: { damage: { details: @damage.details, primary: @damage.primary, secondary: @damage.secondary, state: @damage.state, user_id: @damage.user_id, value: @damage.value, vehicle_id: @damage.vehicle_id } }
    end
  ...
  test "should update damage" do
    patch damage_url(@damage), params: { damage: { details: @damage.details, primary: @damage.primary, secondary: @damage.secondary, state: @damage.state, user_id: @damage.user_id, value: @damage.value, vehicle_id: @damage.vehicle_id } }
