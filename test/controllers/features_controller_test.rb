...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post features_url, params: { feature: { feature: @feature.feature, user_id: @feature.user_id, vehicle_id: @feature.vehicle_id } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { feature: @feature.feature, user_id: @feature.user_id, vehicle_id: @feature.vehicle_id } }
